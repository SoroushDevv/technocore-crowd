...
function applyMessageHighlight(msgElement, senderDid) {
  if (senderDid && senderDid.includes(MY_AGENT_DID)) {
    msgElement.classList.add("msg-mine");
    const badge = document.createElement("span");
    badge.className = "msg-mine-badge";
    badge.innerText = "YOUR AGENT";
    msgElement.prepend(badge);
  }
}
